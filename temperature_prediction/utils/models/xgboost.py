...
from temperature_prediction.utils.hyperparameters.shared import (
...
def train_model(
    ...
    return model, {"mse": mse, "rmse": rmse}, y_pred
...
def tune_hyperparameters(
    ...
    **kwargs,
    ...
    def __objective(
        ...
        if callback:
            params_w = params
            params_w['num_boost_round'] = num_boost_round
            callback(
                hyperparameters=params_w,
                metrics=metrics,
                model=model,
